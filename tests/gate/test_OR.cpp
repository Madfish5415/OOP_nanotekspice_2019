...
Test(OR, constructor_2_pin)
{
    auto *gate = new gate::OR({1, 2}, {3});

    delete gate;
}

Test(OR, compute_2_pin_false_false)
{
    auto *gate = new gate::OR({1, 2}, {3});
...
Test(OR, compute_2_pin_true_false)
{
    auto *gate = new gate::OR({1, 2}, {3});
...
Test(OR, compute_2_pin_true_true)
{
    auto *gate = new gate::OR({1, 2}, {3});
    auto *io1 = new io::True();
...
Test(OR, compute_2_pin_undefined_false)
{
    auto *gate = new gate::OR({1, 2}, {3});
...
Test(OR, compute_2_pin_undefined_true)
{
    auto *gate = new gate::OR({1, 2}, {3});
    auto *io1 = new io::mock::Undefined();
    auto *io2 = new io::True();
